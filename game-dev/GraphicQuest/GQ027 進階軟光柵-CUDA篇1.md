...
這個系列文章的每個部分都對應"One Weekend"書中的其中一章。即使您不坐下來用 C++ 編寫自己的光線追踪器，這裡的核心概念也應該讓您開始了解以及使用 CUDA 基於 GPU 的引擎。將您的 C++ 代碼轉換為 CUDA 可以使速度提高 10 倍或更多！讓我們來看看將 C++ 代碼轉換為 CUDA 的過程。
